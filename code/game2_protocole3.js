...
function updateDisplay(){
   ...
   if(lvlCount==3 || lvlCount==5 || lvlCount==7){
      revealElement(nextButton);
   }
}
...
function resetLevel(){
   switch(lvlCount){
      case 0 :
         ...
         pageText.innerHTML = "Merci pour votre participation à cette expérience!<br/><br/> Ce jeu a pour but d'étudier le phénomène de la perception musicale. Votre rôle sera d'écouter attentivement des oeuvres musicales afin d'annoter les fin de <u>phrases</u> et de <u>section</u> que vous reconnaissez. Vous devrez par ailleurs effectuer un exercice de reproduction de chaînes de caractères 'X' et 'O'" +((ecoID==1)?", puis effectuer les deux exercices en simultané":"") + ".<br/><br/> Cette expérience va se dérouler en plusieurs étapes:<ol> <li> Tout d'abord, vous effectuerez des sessions d'entraînement sur les tâches à effectuer </li><li>Dans un second temps, vous reproduirez pendant un temps défini un ensemble de <u>séquence de caractères</u> 'X' et 'O' présentés à l'écran.</li> <li> Dans la troisième partie de l'étude vous seront présentées des pièces musicales et nous vous demanderons de les segmenter d'une manière qui vous semble intuitive" +((ecoID==1)?", en effectuant la tâche de reproduction des séquences en simultané":"") + ". </li> <li> Après chaque pièce musicale, vous remplirez un questionnaire qui nous aidera à évaluer votre effort lors de l'exécution de la tache </li><li>Enfin, vous répondrez à un court questionnaire concernant vos compétences musicales.</li> </ol> Vos performances et résultats sont totalement anonymes et vous ne serez en aucun cas lié à vos réponses. <br/> <br/> Si vous souhaitez avoir plus de détails sur l'expérimentation, n'hésitez pas à nous laisser votre adresse email à la fin de l'enquête." ;
      break;
      case 1:
         level = new Level('next_pressed', -1);
         pageTitle.textContent = "Explications";
         console.log("ecoID vaut"+ ecoID);
         pageText.innerHTML = ("<br/>Lors de l'expérience, vous écouterez douze pièces musicales. Votre tâche est de vous concentrer sur les morceaux que vous entendrez et, chaque fois que vous pensez pouvoir entendre la fin d'une <u>phrase musicale</u>, pressez la touche 'T' de votre clavier. Chaque fois que vous pensez entendre la fin d'une  <u>section musicale</u>, pressez la touche 'G' du clavier. <br/> La fin d'une section enregistre en même temps la fin d'une phrase, il est donc inutile d'appuyer sur les deux simultanément. <br/>Si vous estimez avoir cliqué au mauvais moment, cliqué sur le bouton 'phrase' puis 'section' en même temps en vous rendant compte d'un changement d'échelle, ou si vous avez effectué d'autres erreurs ce n'est pas grave: faites au mieux !<br/>"+((ecoID==1)?"<br/>En parallèle, vous jouerez à un jeu simple. Votre tâche sera de répéter des séquences  de 'X' et 'O' afin qu'ils correspondent à l'image affichée. <br/> Attention! Si la séquence présentée est écrite en bleu - vous ne devrez pas la copier! Cliquez sur le bouton 'skip' au lieu de la recopier. <br/>":"")+"<br/><u>Quelques définitions:</u><br/><br/> On appelle une <u>unité</u> un élément de quelques secondes qui est reconnaissable à l'échelle macroscopique. Il s'agit par exemple d'un motif ou d'une carrure. En linguistique, différentes unités seraient séparées par des virgules.<br/><br/><img width=35% height=30% src=\"unité.png\"><br/><br/> - Une <u> phrase musicale </u> est une idée conclusive.<br/> Elle est constituée de plusieurs unités et à l'image d'une phrase linguistique, elle contient potentiellement plusieurs virgules et se conclue par un point.<br/><br/><img width=60% height=60% src=\"phrase.png\"><br/><br/> - Une <u>section musicale</u>  est un ensemble de phrases.<br/>Equivalente à une strophe en poésie, elle est comme une histoire. Un changement de section induit un changement d'ambiance.<br/><br/><img width=100% height=100%  src=\"section.png\"><br/> <br/> Vous indiquerez les fins de <u>phrases musicales</u> et de <u>sections musicales</u>. Essayez de suivre vos intuitions en distinguant les deux.");
      break;
      case 2 :
         level = new Level('next_pressed', -1);
